...
The full enterprise version powers high‑volume QR‑payments for businesses, kiosks, airports, ticket terminals, and duty‑free retail — speeding up foot‑traffic flow and reducing queue times.
...
Mobile Users — Small Version
A lightweight QR → Activation → Session → Payment flow designed for speed and simplicity.
Optimised for fans, customers, travellers, and everyday micro‑transactions.

Org‑Users (Multi‑Tenant) — Full Enterprise Version
Creator dashboards, identity verification, passkey login, payment history, QR‑fleet management, and tenant‑level configuration.
...
🔓 Open‑Source Licence — AGPL‑3.0 (Small Mobile Version)
The small mobile version of HoloTap is free for all users and can be downloaded on any mobile device through app stores.
...
academic, creator, and hobbyist experimentation
...
The full business version of HoloTap is available under a commercial licence for organisations that require advanced features, closed‑source deployments, and high‑volume QR‑payment infrastructure.
...
org dashboards, analytics, and reporting
...
multi‑creator organisations

enterprise teams

🏢 Licensing Tiers
Starter — small venues, creators, independent kiosks
Professional — multi‑creator teams, mid‑size organisations
